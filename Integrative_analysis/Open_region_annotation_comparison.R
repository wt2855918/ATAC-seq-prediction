...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_8/GM12878_ATAC_annotation.pdf"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_8/GM12878_DNase_annotation.pdf"
pdf(myoutf,width=5,height=5)
plotAnnoPie(peakAnno)
dev.off()
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/FAIRE_seq_peak_processed_bed/ENCFF001UYE_positive.Rda")
res2 = positive
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_8/GM12878_FAIRE_annotation.pdf"
pdf(myoutf,width=5,height=5)
plotAnnoPie(peakAnno)
dev.off()
