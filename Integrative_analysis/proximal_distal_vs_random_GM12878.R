[1]GM12878 model TF in proximal/distal vs random
rm(list=ls())
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/TF_prediction_promoter_distal.Rda")
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/TF_prediction_promoter_distal_vs_random.Rda"
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/Histone_prediction_promoter_distal.Rda")
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/Histone_prediction_promoter_distal_vs_random.Rda"
save.image(file= myoutf)

#################################
rm(list=ls())
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/TF_prediction_promoter_distal_vs_random.Rda"
load(myinf1)
TF_auc = Model_proximal_AUC

myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Final_ID/Histone_prediction_promoter_distal_vs_random.Rda"
load(myinf2)
...
myoutf1 <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/GM12878/TF_histone_other_Model_proximal_vs_random_prediction_barplot.pdf"
...
#myoutf1 <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/GM12878/TF_histone_other_Model_distal_vs_random_prediction_barplot.pdf"
myoutf1 = "/ihome/yanding/GM12878_TF_histone_other_Model_distal_vs_random_prediction_barplot.pdf"
pdf(myoutf1, width= 3, height= 3)
p <- position_dodge(0.1)
p1 <- ggplot(data=data, aes(x=target, y=AUC, fill=color)) + 
  geom_bar(stat="identity", color="black", position=position_dodge(),width=0.5) + scale_fill_manual(values=c(c2,c1))+guides(fill=FALSE)+scale_y_continuous(expand = c(0,0),limits = c(0, 1)) + geom_text(aes(label=AUC), vjust=1.6, color="white", size=3.5)
