...
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/GM12878/DNase_seq/"
myDir2 = "/lorax/chenglab/yanding/Pub_Dat/GRch38/Fastq_files/"

mytarDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_sequence_ctrl/"
...
mydir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/GM12878/DNase_seq/"
mydir2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_sequence_ctrl/"
...
for(i in 1 : length(my_nam))
{
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_processed_bed/",my_nam[i],"_positive.Rda")
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_processed_bed/",my_nam[i],"_negative.Rda")
...
load(myinf1)
res = res1
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_processed_bed/ENCFF235KUD_positive.Rda"

load(myinf2)
myinf3 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_processed_bed/ENCFF235KUD_negative.Rda"
...
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/GM12878/Histone_DNase_prediction.pdf"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Histone_DNase_prediction_AUC.Rda"
save.image(myoutf)
...
label <- paste0("AUC=",round(mean(1-fit[[3]]),2))
color <- brewer.pal(10,"Set1")[1]
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/GM12878/TF_DNase_prediction.pdf"
pdf(myoutf, width= 5, height= 5)
par(pty="s")
plot(1-fit[[1]],1-fit[[2]],main="Histone", xlab="False Positive Rate (1-Specificity)",ylab="True Positive Rate (Sensitivity)",
xlim=c(0,1),ylim=c(0,1),cex=0,cex.main=1.5,cex.lab=1,font.main=2) #xaxs="i",yaxs="i"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/TF_DNase_prediction_AUC.Rda"
save.image(myoutf)

[5]Histone for proximal vs random
rm(list=ls())
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/DNase_seq_peak_processed_bed/ENCFF235KUD_positive.Rda")
...
res = peakDF2GRanges(positive)
peakAnno <- annotatePeak(res, tssRegion=c(-3000, 3000),TxDb=txdb, annoDb="org.Hs.eg.db")
info = peakAnno@anno
info = as.data.frame(info)

myoutf = "/ihome/yanding/GM12878_positive_DNase_region_annotation.txt"
write.table(info,myoutf,sep="\t",quote=F)

[6]Histon model application
rm(list=ls())
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_Histone_integration_Core.Rda"
