...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_shared_TF_data.Rda")
data = GM12878_data
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/TF_KO_GM12878_summary.xls"
write.table(info,myoutf,sep="\t",quote=F)

myoutf1 <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_5/TF_KO_each_GM12878.pdf"
