...
rm(list=ls())
work_mydir  = "/lorax/chenglab/yanding/ATAC_seq_integration/Scripts/GM12878/Counting_Histone_from_bigWig/"
dir.create(work_mydir)
setwd(work_mydir)

sourcedir = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/GM12878/Histone_ChIP_seq_bigWig/"
bam_files = list.files(sourcedir)
tag = grep(".bigWig",bam_files,fix=T)
bam_files = bam_files[tag]
sam = gsub(".bigWig","",bam_files)

myoutdir = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Histone_logFC/"
...
for(k in 1 : length(bam_files))
{
	...
	curLine = c("cd /lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/GM12878/Histone_ChIP_seq_bigWig/")
	writeLines(curLine, conOut)
...
#begin to submit job
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Scripts/GM12878/Counting_Histone_from_bigWig/"
...
mytardir = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Histone_counts_bins_logFC/"
...
[3]Begin to calculate the signal for pos
rm(list=ls())
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Scripts/GM12878_GM12878_Histone_pos/"
dir.create(myDir1)
...
rm(list=ls())
rm(list=ls())
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Scripts/GM12878_GM12878_Histone_neg/"
dir.create(myDir1)
...
tag_pos = sample(seq(1,895736),2000)
tag_neg = sample(seq(1,895736),2000)

rm(positive)
rm(negative)

res = matrix(0, 2*length(tag_pos), nrow(info))
...
1-fit[[3]]
 [1] 0.8492638 0.8488479 0.8482346 0.8477049 0.8490797 0.8492273 0.8491343
 [8] 0.8490806 0.8487191 0.8481652
