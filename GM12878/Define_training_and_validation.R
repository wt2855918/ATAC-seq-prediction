...
positive_bins = bins
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Pos_bin_Histone.Rda"
...
negative_bins = bins
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Neg_bin_Histone.Rda"
...
positive_bins = bins
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Pos_bin_TF.Rda"
save(positive_bins,file = myoutf)
...
[1] 895704
negative_bins = bins
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Neg_bin_TF.Rda"
save(negative_bins,file = myoutf)
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Pos_bin_Histone.Rda")
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Total_bins/Neg_bin_Histone.Rda")

res = matrix(0, 1791441, nrow(info))
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_Histone_integration_Total.Rda"
save.image(file = myoutf)

[4]Begin to calcualte all bins in TFs
rm(list=ls())
mydir = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/TF_counts_bins_logFC/"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_TF_integration_Total.Rda"
save.image(file = myoutf)

[5]Define the shared region between TF and Histone
rm(list=ls())
myinf1= "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_Histone_integration_Total.Rda"
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_TF_integration_Total.Rda"
...
myoutf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_Histone_integration_Core.Rda"
save(res1, file = myoutf1)

myoutf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_TF_integration_Core.Rda"
save(res2, file = myoutf2)

[6]sequence define positive sequence #Use current histone as the golden standard for testing since its high AUC
rm(list=ls())
library("Biostrings")
library("reticulate")
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/Integration/GM12878_Histone_integration_Core.Rda")
tag = res1$tag == "1"
positive = res1[tag,]
...
library("Biostrings")
library("reticulate")
myinf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1/ENCFF172DEA_random_negative_peak.fa"
fastaFile <- readDNAStringSet(myinf)

#begin to get sequence file
tag = sample(seq(1,length(fastaFile)),20000)

training_fasta = fastaFile[tag]

myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1_training_and_validation/ENCFF172DEA_random_negative_training.fa"
writeXStringSet(training_fasta, myoutf)

[6]Random sample non overlap
rm(list=ls())
library("Biostrings")
library("reticulate")
myinf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1/ENCFF172DEA_random_negative_non_flank_overlap_peak.fa"
fastaFile <- readDNAStringSet(myinf)
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1_training_and_validation/ENCFF172DEA_random_negative_non_flank_overlap_training.fa"
writeXStringSet(training_fasta, myoutf)
