[1]Model training
rm(list=ls())
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/CNN/GM12878_local_training_CNN.Rda")
...
myoutf ="/lorax/chenglab/yanding/ATAC_seq_integration/Figures/CNN/CNN_GM12878_training.pdf"
...
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_2/ROC_Curve_CNN_training.pdf"
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/CNN/GM12878_local_validation_CNN.Rda")
...
color <- brewer.pal(10,"Set1")[3]
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_2/ROC_Curve_CNN_validation.pdf"
pdf(myoutf, width= 5, height= 5)
par(pty="s")
plot(xx,yy,main="", xlab="False Positive Rate (1-Specificity)",ylab="True Positive Rate (Sensitivity)",
xlim=c(0,1),ylim=c(0,1),cex=0,cex.main=1.5,cex.lab=1,font.main=2) #xaxs="i",yaxs="i"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/CNN/GM12878_local_CNN_model.Rda"
save.image(myoutf)