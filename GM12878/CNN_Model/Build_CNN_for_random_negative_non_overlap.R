...
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1_training_and_validation/ENCFF172DEA_positive_training.fa"
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/ATAC_seq_bin_sequence/Batch_1_training_and_validation/ENCFF172DEA_random_negative_non_flank_overlap_training.fa"
...
model %>% 
  ...
  layer_conv_1d(filter = 480, kernel_size = 10, activation = 'relu', input_shape = c(100, 4)) %>% 
  layer_dropout(rate = 0.25) %>%
  layer_max_pooling_1d(pool_size = 2) %>%
  layer_flatten() %>%
...
myoutf ="/lorax/chenglab/yanding/ATAC_seq_integration/Figures/CNN/CNN_training_non_overlap.pdf"
...
myauc
0.59
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/GM12878/CNN/GM12878_random_CNN_non_overlap.Rda"
save.image(myoutf)