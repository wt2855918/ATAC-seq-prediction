...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Histone_integration_prediction.Rda"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Histone_prediction_model.Rda"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/TF_integration_prediction.Rda"
save.image(file=myoutf)
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/TF_prediction_model.Rda"
save(model,file=myoutf)


[3]Motif score claculation
rm(list=ls())
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/HepG2_training_and_validation_pos.Rda")
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/HepG2_training_and_validation_neg.Rda")
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Motif_integration_prediction.Rda"
save.image(file = myoutf)

myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Motif_prediction_model.Rda"
save(model,file=myoutf)

[4]Seq+TF models
rm(list=ls())
library(randomForest)
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/CNN/HepG2_local_CNN_model.Rda")
seq_data = prob
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Seq_TF_integration_prediction.Rda"
save.image(file=myoutf)
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Seq_Histone_integration_prediction.Rda"
save.image(file=myoutf)
...
load("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Motif_integration_prediction.Rda")
data = cbind(data,seq_data)

source("/lorax/chenglab/yanding/ATAC_seq_integration/Function/RF_multi_var_prediction_10_CV.R")
fit = ROC(data) 

myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Seq_Motif_integration_prediction.Rda"
save.image(file=myoutf)
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Seq_Motif_Histone_TF_integration_prediction.Rda"
save.image(file=myoutf)
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Histone_TF_integration_prediction.Rda"
save.image(file=myoutf)
