...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_TF_integration.Rda"
...
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_Histone_integration.Rda"
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_TF_integration.Rda"
myinf3 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_motif_integration.Rda"

load(myinf2)
res2 = data
row.names(res2) = c(row.names(pos),row.names(negative))
