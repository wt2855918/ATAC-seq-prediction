...
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/FAIRE-seq/"
myDir2 = "/lorax/chenglab/yanding/Pub_Dat/GRch38/Fastq_files/"

mytarDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_sequence_ctrl/"
...
mydir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/FAIRE-seq/"
mydir2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_sequence_ctrl/"
...
for(i in 1 : length(my_nam))
{
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_processed_bed/",my_nam[i],"_positive.Rda")
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_processed_bed/",my_nam[i],"_negative.Rda")
...
load(myinf1)
res = res1
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_processed_bed/ENCFF001UYN_positive.Rda"

load(myinf2)
myinf3 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/FAIRE_seq_peak_processed_bed/ENCFF001UYN_negative.Rda"
...
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/Histone_FAIR_prediction.pdf"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Histone_FAIR_prediction_AUC.Rda"
save.image(myoutf)
...
label <- paste0("AUC=",round(mean(1-fit[[3]]),2))
color <- brewer.pal(10,"Set1")[1]
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/TF_FAIR_prediction.pdf"
pdf(myoutf, width= 5, height= 5)
par(pty="s")
plot(1-fit[[1]],1-fit[[2]],main="Histone", xlab="False Positive Rate (1-Specificity)",ylab="True Positive Rate (Sensitivity)",
xlim=c(0,1),ylim=c(0,1),cex=0,cex.main=1.5,cex.lab=1,font.main=2) #xaxs="i",yaxs="i"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/TF_FAIR_prediction_AUC.Rda"
save.image(myoutf)
