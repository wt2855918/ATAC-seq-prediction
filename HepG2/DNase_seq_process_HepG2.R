...
load(myinf1)
res = res1
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/ENCFF571RHF_positive.Rda"

load(myinf2)
myinf3 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/ENCFF571RHF_negative.Rda"
...
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/Histone_DNase_prediction.pdf"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Histone_DNase_prediction_AUC.Rda"
save.image(myoutf)
...
label <- paste0("AUC=",round(mean(1-fit[[3]]),2))
color <- brewer.pal(10,"Set1")[1]
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/TF_DNase_prediction.pdf"
pdf(myoutf, width= 5, height= 5)
par(pty="s")
plot(1-fit[[1]],1-fit[[2]],main="Histone", xlab="False Positive Rate (1-Specificity)",ylab="True Positive Rate (Sensitivity)",
xlim=c(0,1),ylim=c(0,1),cex=0,cex.main=1.5,cex.lab=1,font.main=2) #xaxs="i",yaxs="i"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/TF_DNase_prediction_AUC.Rda"
save.image(myoutf)
