...
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/DNase_seq/"
myDir2 = "/lorax/chenglab/yanding/Pub_Dat/GRch38/Fastq_files/"

mytarDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_sequence_ctrl/"
...
mydir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/DNase_seq/"
mydir2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_sequence_ctrl/"
...
for(i in 1 : length(my_nam))
{
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/",my_nam[i],"_positive.Rda")
	...
	tag = sample(1:length(peak_kept), min(nrow(positive),length(peak_kept)), replace=F)
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/",my_nam[i],"_negative.Rda")
...
rm(list=ls())
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_Histone_integration_Core.Rda"

load(myinf1)
res = res1
myinf2 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/ENCFF422EDI_positive.Rda"

load(myinf2)
myinf3 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/DNase_seq_peak_processed_bed/ENCFF422EDI_negative.Rda"
...
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/Histone_DNase_prediction_GRRCH38.pdf"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Histone_DNase_prediction_AUC_GRRCH38.Rda"
save.image(myoutf)


[4]Begin to predict using TF
rm(list=ls())
myinf1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Integration/HepG2_TF_integration_Core.Rda"
...
label <- paste0("AUC=",round(mean(1-fit[[3]]),2))
color <- brewer.pal(10,"Set1")[1]
myoutf <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/HepG2/TF_DNase_prediction_GRRCH38.pdf"
pdf(myoutf, width= 5, height= 5)
par(pty="s")
plot(1-fit[[1]],1-fit[[2]],main="Histone", xlab="False Positive Rate (1-Specificity)",ylab="True Positive Rate (Sensitivity)",
xlim=c(0,1),ylim=c(0,1),cex=0,cex.main=1.5,cex.lab=1,font.main=2) #xaxs="i",yaxs="i"
...
myoutf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/TF_DNase_prediction_AUC_GRRCH38.Rda"
save.image(myoutf)
