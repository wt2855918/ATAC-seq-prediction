...
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/ATAC_seq/"
myDir2 = "/lorax/chenglab/yanding/Pub_Dat/GRch38/Fastq_files/"

mytarDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_peak_sequence_ctrl/"
...
mydir1 =  "/lorax/chenglab/yanding/ATAC_seq_integration/Data/Raw_Data/HepG2/ATAC_seq/"
mydir2 =  "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_peak_sequence_ctrl/"
...
for(i in 1 : length(my_nam))
{
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_peak_processed_bed/",my_nam[i],"_positive.Rda")
	...
	myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_peak_processed_bed/",my_nam[i],"_negative.Rda")
...
rm(list=ls())
myDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_peak_processed_bed/"
#myDir2 = "/lorax/chenglab/yanding/Pub_Dat/GRch38/Fastq_files/"
myDir2 = "/lorax/chenglab/cc59/PubDat/organisms/human/genome/hg19/"

mytarDir1 = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/ATAC_seq_bin_sequence/"
dir.create(mytarDir1)
