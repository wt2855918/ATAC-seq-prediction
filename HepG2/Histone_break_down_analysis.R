...
for(i in 1 : (length(tar)-1))
{
	...
	if(i== (length(tar)-1))
	{
		...
		fit = ROC_uni(test)
		myoutf = paste0("/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Histone_KO_RF/HepG2_Order_",i,"_",tar[i],"_KO_histone.Rda")
...
[2]Plot figure
rm(list=ls())
mydir = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Histone_KO_RF/"
files = list.files(mydir)

tmpinf = "/lorax/chenglab/yanding/ATAC_seq_integration/Data/HepG2/Final_ID/Histone_integration_prediction.Rda"
...
myoutf1 <- "/lorax/chenglab/yanding/ATAC_seq_integration/Figures/MS_Figure/Figure_2/Histone_KO_each_HepG2.pdf"
